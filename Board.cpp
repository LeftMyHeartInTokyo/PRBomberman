...
#define OBJECTSINLINE 20 //ilość obiektów planszy w 1 linii
#define WIDTH 32
#define HEIGHT 32
...
Board::Board(char *nameOfFile, SDL_Surface *screen, Player * player)
{
	...
	this->screen = screen;
	LoadBoardFromFile(); //załadowanie planszy
	this->player = player;
	player->board = this;//wskaźnik do planszy dla gracza
}
...
{
	char line[22];//+1 <- na koniec łancucha znaków '\0'
	int currentLine = 0;
	FILE *fp;
...
//sprawdź, czy w tym momencie mają zniknąć jakieś bomby
